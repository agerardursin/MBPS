...
t_data = np.array([177, 203, 163, 156, 150])
m_data = np.array([689.9281, 752.518, 430.9353, 271.223, 156.8345])
m_data = m_data/1E3
...
ax6c.plot(t_grs, f_prc, label=r'$Temperature$')
# ax6b.legend()
ax6c.set_ylabel('Precipitation ' + r'$[mm d-1]$')
