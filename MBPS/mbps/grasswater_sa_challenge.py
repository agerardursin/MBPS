...
df_grs = pd.DataFrame(SNS_grs_tbl, columns=['a',  # [m2 kgC-1] structural specific leaf area
                                            ...
                                            'z'],
                      index=['start+', 'start-', 'End+', 'End-', 'Middle+', 'Middle-', 'Average+', 'Average-'])
...
# df_grs_ref.to_excel(r"C:/Users/alek-/Documents/Wageningen Period 2/MBPS/MBPS/case3_SA_challenge3_grs_ref.xlsx")
# df_wtr_ref.to_excel(r"C:/Users/alek-/Documents/Wageningen Period 2/MBPS/MBPS/case3_SA_challenge3_wtr_ref.xlsx")
# df_grs.to_excel(r"C:/Users/alek-/Documents/Wageningen Period 2/MBPS/MBPS/case3_SA_challenge3_grs.xlsx")
# df_wtr.to_excel(r"C:/Users/alek-/Documents/Wageningen Period 2/MBPS/MBPS/case3_SA_challenge3_wtr.xlsx")
...
# plt.plot(t_grs, SNS_grs_pls[:, 0], label=r'$a+$', color=cmap(0))
# plt.plot(t_grs, SNS_grs_min[:, 0], label=r'$a-$', linestyle='--', color=cmap(0))
# plt.plot(t_grs, SNS_grs_pls[:, 1], label=r'$\alpha+$', color=cmap(0.3))
# plt.plot(t_grs, SNS_grs_min[:, 1], label=r'$\alpha-$', linestyle='--', color=cmap(0.3))
...
# plt.plot(t_grs, SNS_grs_pls[:, 12], label=r'$Y+$', color=cmap(0.6))
# plt.plot(t_grs, SNS_grs_min[:, 12], label=r'$Y-$', linestyle='--', color=cmap(0.6))
plt.legend()
plt.ylim(-0.1, 0.8)
plt.xlabel('time' + r'$[d]$')
...
# plt.plot(t_wtr, SNS_wtr_pls[:, 2], label=r'$alb+$', color=cmap(0.3))
# plt.plot(t_wtr, SNS_wtr_min[:, 2], label=r'$alb-$', linestyle='--', color=cmap(0.3))
# plt.plot(t_wtr, SNS_wtr_pls[:, 1], label=r'$\gamma+$', color=cmap(0.6))
# plt.plot(t_wtr, SNS_wtr_min[:, 1], label=r'$\gamma-$', linestyle='--', color=cmap(0.6))
plt.legend()
